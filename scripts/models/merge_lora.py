...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description='Merge and save a pre-trained model.')
    parser.add_argument('--model_name', type=str, 
                        default='hodza/BlackBox-Coder-3B', 
                        help='Name of the model to load.')
    parser.add_argument('--base_model_name', type=str,
                        default='Qwen/Qwen2.5-Coder-3B-Instruct', 
                        help='Name of the base model to load.')
    parser.add_argument('--merged_model_path', type=str, 
                        default='/app/models/BlackBox-Coder-3B-merged', 
