...
def main(
    ...
    Args:
        ...
        The path to the text dataset directory.
        text_dataset_name (str): 
        The name of the text dataset to push to the Hub.
        json_dataset_path (str): 
        The path to the JSON dataset file.
        json_dataset_name (str): 
        The name of the JSON dataset to push to the Hub.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Push datasets to the Hugging Face Hub.")
    parser.add_argument(
        "--text_dataset_path",
        required=True,
        help="Path to the text dataset directory.")
    parser.add_argument(
        "--text_dataset_name",
        required=True,
        help="Name of the text dataset to push to the Hub.")
    parser.add_argument(
        "--json_dataset_path",
        required=True,
    ...
    parser.add_argument(
        "--json_dataset_name",
        required=True,
        help="Name of the JSON dataset to push to the Hub.")

    args = parser.parse_args()

    main(
        args.text_dataset_path,
        args.text_dataset_name,
        args.json_dataset_path,
