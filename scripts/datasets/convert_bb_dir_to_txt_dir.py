...
def convert_files(source_dir, dest_dir):
    """
    Convert .odc files in the source directory
      to text files in the destination directory.

    Args:
    - source_dir (str): The path to the source
      directory containing .odc files.
    - dest_dir (str): The path to the destination directory where converted
      files will be saved.
    """
    ...
    # Recursively walk through all files and 
    # subdirectories in the source directory
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Convert .odc files to text files.")
    parser.add_argument('source_dir', type=str,
                        help="The source directory containing .odc files.")
